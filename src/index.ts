...
app.post("/api/conversations/:id/messages", async (c) => {
  ...
  // Kasih judul dari pesan pertama SEGERA, jangan tunggu balasan AI berhasil -
  // supaya percakapan tetap punya nama walau AI gagal (mis. limit kuota).
  await renameConversationIfDefault(c.env.DB, conversation.id, text || "Foto terkirim");
